...
void main() {
  test('parse github repo json to object ', () {
    final map = {
      "id": 1,
    ...
    final githubRepo = GithubRepo.fromJson(map);

    expect(githubRepo.name , "grit");
    expect(githubRepo.fullName , "mojombo/grit");
    expect(githubRepo.owner.login , "mojombo");
  });
}
